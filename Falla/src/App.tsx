              ...
              return (
                <div className="bg-white border-2 border-slate-200 rounded-3xl overflow-hidden shadow-2xs relative">
                  ...
                  <div 
                    ...
                    className={`h-28 sm:h-32 w-full relative transition-all duration-300 ${animClass}`}
                  />
                  ...
                  <div className="p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative -mt-10 sm:-mt-12 z-10">
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <button 
                        ...
                        onClick={() => setIsMascotSelectorOpen(true)}
                        title="Clique para alterar seu mascote!"
                        className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl overflow-hidden border-4 border-white bg-sky-50 shadow-md flex items-center justify-center shrink-0 hover:scale-105 hover:border-sky-300 transition-all cursor-pointer relative group"
                      >
                        {renderAvatarContent(userProgress.avatarMascot)}
                        <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                          <span className="text-white text-[10px] font-black uppercase tracking-wider">Mudar</span>
                        </div>
                      </button>
                    ...
                    <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto justify-start sm:justify-end mt-2 sm:mt-0">
                      ...
                      <div className="bg-indigo-50 border-2 border-indigo-200 rounded-2xl px-4 py-2 flex items-center gap-2 shadow-3xs">
                        <span className="text-xl">👑</span>
                        <div>
                          <p className="text-[9px] font-black text-indigo-500 uppercase tracking-wider leading-none">Plano</p>
                          <p className="text-sm font-black text-indigo-800 mt-0.5">
                            {userProgress.plan === 'pro' || userProgress.plan === 'premium' ? 'Pro' : 'Free'}
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="p-6 pt-0 relative flex flex-col md:flex-row items-center md:items-end gap-6 -mt-14 md:-mt-16 z-10 text-center md:text-left">
                        ...
                        <div className="relative shrink-0 group">
                          <button 
                            ...
                            onClick={() => setIsMascotSelectorOpen(true)}
                            title="Clique para alterar seu mascote!"
                            className="w-28 h-28 rounded-full overflow-hidden border-4 border-white bg-sky-50 shadow-md flex items-center justify-center cursor-pointer hover:scale-105 hover:border-sky-300 transition-all relative"
                          >
                            {renderAvatarContent(userProgress.avatarMascot)}
                            <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                            ...
                            >
                              <div className="space-y-2">
                                ...
                                <div 
                                  ...
                                  className={`h-16 w-full rounded-xl shadow-xs border border-slate-100 flex items-center justify-center relative overflow-hidden ${animClass}`}
                                >
                                  {!isUnlocked && (
